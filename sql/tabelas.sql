...
select  b.nome,b.id AS identificador_bode,p.id AS identificador_produto,p.categoria,p.preco,p.peso,p.quantidade,pb.*  from bode b , produto p , bode_produto pb
...
SELECT b.nome,b.id AS identificador_bode,p.id AS identificador_produto,p.categoria,p.preco,p.peso,p.quantidade,bp.*
